...
public class EdgeOfScreenCollision : MonoBehaviour
{
    ...
    public PhysicsMaterial2D bounces;
    ...
    private void Start()
    {
        ...
        topCollider.gameObject.GetComponent<BoxCollider2D>().sharedMaterial = bounces;
        bottomCollider.gameObject.GetComponent<BoxCollider2D>().sharedMaterial = bounces;
        topCollider.gameObject.GetComponent<BoxCollider2D>().sharedMaterial = bounces;
        topCollider.gameObject.GetComponent<BoxCollider2D>().sharedMaterial = bounces;
